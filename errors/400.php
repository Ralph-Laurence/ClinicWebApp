...
<body>
    ...
    <div class="container w-100 h-100 d-flex flex-column align-items-center justify-content-center">
        <img src="../assets/images/errors/400.png" alt="icon">
        <h5 class="mt-4"> 
            <span class="fw-bold font-base">400</span>
            <span class="mx-3 border border-end border-secondary"></span>
            <span class="text-uppercase text-muted">BAD REQUEST</span>
        </h5>
        <span class="text-muted my-3">
            You've sent a bad request and the<br>server cannot or will not process it
        </span>
