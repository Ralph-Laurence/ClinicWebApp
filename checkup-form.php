                ...
                <section class="workarea w-100 pb-5">
                    ...
                    <div class="checkup-form-wrapper p-4 w-100 h-100 overflow-hidden position-relative">
                        ...
                        <div class="checkup-form bg-white shadow-2-strong w-100 h-100 p-4 scrollable" style="overflow-y: auto;">
                            ...
                            <form action="includes/action.add-checkup.php" method="POST" class="checkup-form">
                                ...
                                <div class="d-flex flex-row-reverse gap-2">
                                    <button type="submit" name="submit" class="btn btn-primary bg-base btn-submit" disabled>SUBMIT</button>
                                    <button type="reset" class="btn btn-secondary fw-bold btn-reset">CANCEL</button>
                                </div>
                            </form>
                        </div>
