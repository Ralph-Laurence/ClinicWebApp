                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="form-outline mb-3 me-auto">
                                                <input type="text" name="input-age" class="form-control" />
                                                <label class="form-label" for="input-age">Age</label>
                                            </div>
                                            <div class="form-outline mb-3 ms-2">
                                                <input type="text" name="input-weight" class="form-control" />
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="form-outline mb-3 me-auto">
                                                <input type="text" name="input-systolic" class="form-control" />
                                                <label class="form-label" for="input-systolic">Systolic</label>
                                            </div>
                                            <div class="form-outline mb-3 ms-2">
                                                <input type="text" name="input-diastolic" class="form-control" />
