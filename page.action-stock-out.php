<?php require_once("controllers/StockOutController.php"); ?>
...
<body>
    ...
    <form action="<?= Tasks::STOCK_OUT ?>" method="post" class="frm-restock d-none">
        <input type="text" name="item-key" class="item-key">
        <input type="text" name="qty" class="qty">
        <input type="text" name="moveToWaste" id="h-moveToWaste">
        <input type="text" name="wasteReason" id="h-wasteReason"/>
    </form>
    <form action="<?= Pages::STOCK_OUT ?>" method="get" class="filter-form d-none">
