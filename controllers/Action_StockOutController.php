...
{
    global $stockOnHand, $s, $itemDetails, $security;
        ...
        foreach ($stockOnHand as $obj)
        {
            ...
            <tr class="align-middle stock-list-tr">
                <td class="text-truncate ">
                    <div class="text-primary fw-bold fsz-12 sku text-uppercase">$sku</div>
                ...
                <td class="d-none">
                    ...
                    <input type="text" class="stock-total-qty" value="$qty_raw"/>
                </td>
            </tr>
            TR;
        }
