...
{  
    global $dataset, $itemFields, $security, $totalCritical, $totalSoldout, $expiredStocks;
...
function getSuccessMessage()
{
    ...
    if (isset($_SESSION['stockin-action-success']))
    {
        $message = $_SESSION['stockin-action-success'];
        unset($_SESSION['stockin-action-success']);
    }
