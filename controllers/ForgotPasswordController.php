...
if (isset($_SESSION['forgot-passw-last-inputs']))
{
    $lastInputs = $_SESSION['forgot-passw-last-inputs'];
    unset($_SESSION['forgot-passw-last-inputs']);
}
...
function getErrorMessage()
{
    ...
    if (isset($_SESSION["forgot-passw-err-msg"]))
    {
        $msg = $_SESSION["forgot-passw-err-msg"];
        unset($_SESSION["forgot-passw-err-msg"]);
    }
