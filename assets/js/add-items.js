...
{  
    ...
    inputTotalStock = $(".input-total-stock");
    ...
    Input.forceNumeric(System.getClass(inputTotalStock));
...
function validateForm()
{
    ...
    // check total stock
    if (System.isNullOrEmpty(inputTotalStock.val()))
    {
        dialog.warn("Total stock value is invalid! Value must be 0 or greater.");
        return false;
    }
    // check reserve stock
...
function saveNewItem()
{
    var payload = 
    {
        ...
        totalStock: inputTotalStock.val(),
    ...
    $.ajax({
        url: "ajax/ajax.add-new-item.php",
        type: "POST",
        data: {
        ...
        success: function(responseCode)
        {
            ...
            {
                case "0x000":
                    snackbar.show("Item successfully added!");
                    resetForm();
                    break;
                case "0x400":
