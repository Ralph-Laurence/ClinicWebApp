...
[
    ...
    {   el: $("#password"),         msg: "Please add a valid password!"   , frame: 1 },
    {   el: $("#retype-password"),  msg: "Passwords didn't matched!"      , frame: 1 },
];
...
function onBind()
{
    ...
    {  
        ...
        {
            var msg = "This action won't take effect. Super Admin accounts always have full access to features.";
            toast.show(msg, "Deny Access", toast.toastTypes.DANGER, true, 5500);
        }
    })
...
{   
    ...
    if (!checkLength($("#password"), 'Password', 4, 1))
        return;

    // Match password retype
    if ($("#password").val() != $("#retype-password").val())
    {
        showError("Passwords didn't matched!");
        carousel.to(1);
