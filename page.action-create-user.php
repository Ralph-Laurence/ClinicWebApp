...
require_once($rootCwd . "controllers/CreateUserController.php");
...
<body>
    ...
    <div class="main-workarea flex-grow-1 d-flex flex-column h-100 bg-white shadow-2-strong overflow-hidden px-4 py-2">
        ...
        <div class="breadcrumbs mb-3 w-100 d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="breadcrumb-arrow fsz-12 fas fa-play mx-3"></div>
            <img src="assets/images/icons/bcrumb-create-user.png" width="20" height="20">
            ...
            <div class="col-8 h-100 flex-grow-1 overflow-hidden d-flex flex-column">
                ...
                <div data-simplebar class="w-100 h-100 flex-grow-1 overflow-y-auto no-native-scroll">
                    ...
                    <div id="carousel-main" class="carousel slide h-100 flex-grow-1" data-mdb-ride="carousel" data-mdb-interval="false">
                        <form action="<?= Tasks::CREATE_USER ?>" method="POST" id="register-form" class="overflow-hidden">
                                        ...
                                        <div class="col-4">
                                            <div class="w-100 h-100 p-2">
                                                <div class="form-outline mb-3">
                                                    <input type="text" name="fname" id="fname" class="form-control apply-validation alpha" value="<?= loadName('f') ?>" maxlength="32" required />
                                                    <label class="form-label" for="fname">Firstname *</label>
                                                </div>
                                                <div class="form-outline mb-3">
                                                    <input type="text" name="mname" id="mname" class="form-control apply-validation alpha" value="<?= loadName('m') ?>" maxlength="32" />
                                                    <label class="form-label" for="mname">Middlename</label>
                                                </div>
                                                <div class="form-outline">
                                                    <input type="text" name="lname" id="lname" class="form-control apply-validation alpha" value="<?= loadName('l') ?>" maxlength="32" required />
                                        ...
                                        <div class="col-4">
                                            <div class="w-100 h-100 p-2">
                                                <div class="form-outline mb-2">
                                                    <input class="form-control bg-white apply-validation alphanum" name="email" id="email" value="<?= loadEmail() ?>" type="text" maxlength="32" required />
                                                    <label class="form-label" for="regnum">Email *</label>
                                                </div>
                                                <div class="avatar-picker d-flex gap-2 align-items-center">
                                                    <div class="d-inline-flex p-1 rounded-circle border border-2 border-primary">
                                                        <img class="avatar-preview" src="assets/images/avatars/who.png" width="36" height="36">
                                                    </div>
                                                    <button type="button" class="btn btn-secondary fw-bold py-1 px-2" data-mdb-toggle="modal"
                                                    data-mdb-target="#findAvatarModal">
                                                        Select Avatar
                                                    </button>
                                                </div>
                                                <input type="text" name="avatar-data" class="avatar-data d-none">
                                            </div> 
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                ...
                                <div class="carousel-item carousel-export">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="w-100 h-100 p-2">
                                                <div class="form-outline mb-3">
                                                    <input type="text" name="uname" id="username" class="form-control apply-validation alphanum" required maxlength="32" value="<?= loadUsername() ?>" />
                                                    <label class="form-label" for="username">Username *</label>
                                                </div>
                                                <div class="form-outline mb-3">
                                                    <input type="password" name="password" id="password" class="form-control apply-validation" required maxlength="32" />
                                                    <label class="form-label" for="password">Password *</label>
                                                </div>
                                                <div class="form-outline">
                                                    <input type="password" id="retype-password" class="form-control apply-validation" required maxlength="32" />
                                ...
                                <div class="carousel-item carousel-security">
                                    <div class="perm-notes display-none">
                                        <div class="d-flex align-items-center w-100 fsz-14" style="height: 28px; max-height: 28px; color: #73510D;">
                                            ...
                                            <div class="perm-note-content flex-fill px-2 h-100 bg-amber-light d-flex align-items-center pt-1"></div>
                                        </div>
                                    </div>
    ...
    <script src="assets/js/page.action-create-user.js"></script>
