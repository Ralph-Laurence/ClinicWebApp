...
require_once($rootCwd . "controllers/RegisterSupplierController.php");
?>
...
<body>
    ...
    <div class="main-workarea flex-grow-1 d-flex flex-column h-100 bg-white shadow-2-strong overflow-hidden px-2 py-2">
        ...
        <div class="breadcrumbs px-2 w-100 d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="breadcrumb-arrow fsz-12 fas fa-play mx-3"></div>
            <img src="assets/images/icons/icn_plus.png" width="20" height="20">
            <div class="ms-2 fw-bold fs-6">Add Supplier</div>
        </div>
        <!--DIVIDER-->
        <hr class="hr divider mx-2 my-2" />

        <div data-simplebar class="w-100 h-100 overflow-y-auto no-native-scroll">
            <form action="<?= Tasks::REGISTER_SUPPLIER ?>" method="POST" id="register-form" class="container overflow-hidden needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <div class="form-outline mb-3">
                            <input type="text" name="supname" class="form-control input-supname alphanum" value="<?= loadLastInput($fields->name) ?>" required maxlength="32" />
                    ...
                    <div class="col-3">
                        <div class="form-outline mb-3">
                            <input type="text" name="contact" class="form-control input-contact numerics" maxlength="13" value="<?= loadLastInput($fields->contact) ?>">
