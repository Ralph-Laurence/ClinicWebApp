...
require_once($rootCwd . "includes/inc.login-controller.php");
        ...
        <div class="login-box-wrapper row shadow">
            ...
            <div class="col-6 bg-base rounded-start position-relative">
                ...
                <div class="login-background-overlay-col z-10 position-absolute start-0 end-0 top-0 bottom-0 w-100 h-100
                    ...
                    <h6 class="text-white text-uppercase">CLINIC INVENTORY & INFORMATION SYSTEM</h6>
            ...
            <div class="col bg-white rounded-end d-flex flex-column align-items-center px-5 pt-5">
                ...
                <div class="inputs-wrapper w-100 mx-2">
                    ...
                    <div class="alert alert-danger auth-warning <?php if ($errorCount < 1) echo 'display-none'; ?>">
                        <i class="fas fa-exclamation-triangle"></i>
                        <small class="ms-2">Incorrect username or password!</small>
                    </div>
                    <form action="" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <div class="form-outline w-100">
                                    <input type="text" name="input-username" id="input-username" class="form-control" value="<?php if (!empty($username)) echo $username; ?>" required />
                        ...
                        <div class="form-submit text-end">
                            <button type="submit" class="btn btn-primary bg-base">Login</button>
                        </div>
                    </form>
                </div>
            </div>
