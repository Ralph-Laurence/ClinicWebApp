...
require_once($rootCwd . "controllers/DoctorRecordsController.php");
?>
...
<body>
                ...
                <div class="left-half me-auto">
                    <div class="control-elements d-flex flex-row gap-2 flex-wrap">
                        <div class="form-outline">
                            ...
                            <label class="form-label" for="form12">Find Doctors</label>
                        </div>
                        <div class="selectmenu-wrapper">
                            <select class="combo-box">
                                <option value="0">By Name</option>
                                <option value="1">By Registration No.</option>
                            </select>
                        </div>
                        ...
                        <div class="dropdown actionbar-sort">
                            ...
                            <ul class="dropdown-menu shadow-3-strong dropdown-menu-custom-light py-2" aria-labelledby="options-dropdown-button ul-li-pointer">
                                ...
                                <li onclick="sortBy(2, 1)" class="d-flex align-items-center gap-3 px-3 py-1 dropdown-item-custom-light">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="assets/images/icons/sort-up.png" width="18" height="18">
                                        <div class="fs-6">Registration #</div>
                                    </div>
                                </li>
                                <li onclick="sortBy(3, 1)" class="d-flex align-items-center gap-3 px-3 py-1 dropdown-item-custom-light">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="assets/images/icons/sort-up.png" width="18" height="18">
                                        <div class="fs-6">Specialization</div>
                                    </div>
                                </li>
                                <li>
                        ...
                        <div class="dropdown actionbar-options">
                            ...
                            <ul class="dropdown-menu shadow-3-strong dropdown-menu-custom-light py-2" aria-labelledby="options-dropdown-button ul-li-pointer">
                                ...
                                <li class="d-flex align-items-center gap-3 px-3 py-1">
                                    ...
                                    <small class="fw-bold text-uppercase font-base">Filter Doctors</small>
                                </li> 
                                <?= createFilterItems(); ?>
                                <li>
                                    <hr class="dropdown-divider" />
                                ...
                                <li>
                                    <a href="<?= Pages::REGISTER_DOCTOR ?>" class="d-flex align-items-center gap-3 px-3 py-1 dropdown-item-custom-light">
                                        <div class="dropdown-item-icon text-center"></div>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="assets/images/icons/bcrumb-reg-doc.png" width="18" height="18">
                                            <div class="fs-6">Add New Doctor</div>
                                        </div>
                                    </a>
                                </li>
            ...
            <div class="col col-count-indicators d-flex gap-2 align-items-center flex-wrap">
                ...
                <div class="display-none effect-reciever" data-transition-index="1" data-transition="fadein">
                    <div class="capsule-badge fsz-14 text-white d-flex align-items-center">
                        <div class="capsule-badge-bg rounded-start px-2">Total Doctors</div>
                        <div class="bg-green rounded-end px-2 capsule-badge-indicator badge-totalDoctors">0<?php //= $totalDoctors ?></div>
                    </div>
                </div>
                <div class="display-none effect-reciever" data-transition-index="2" data-transition="fadein">
                    <div class="capsule-badge fsz-14 text-white d-flex align-items-center">
                        <div class="capsule-badge-bg rounded-start px-2">With Patients</div>
                        <div class="bg-primary rounded-end px-2 capsule-badge-indicator badge-withPatients">0<?php //= $withPatients ?></div>
                    </div>
                </div>
                <div class="display-none effect-reciever" data-transition-index="3" data-transition="fadein">
                    <div class="capsule-badge fsz-14 text-white d-flex align-items-center">
                        <div class="capsule-badge-bg rounded-start px-2">W/o Patients</div>
                        <div class="bg-warning rounded-end px-2 capsule-badge-indicator badge-withoutPatients">0<?php //= $withoutPatients ?></div>
                    </div>
                </div>
        ...
        <div data-simplebar class="w-100 h-100 overflow-y-auto no-native-scroll datatable-wrapper border display-none effect-reciever" data-transition-index="2" data-transition="fadein">
            <table class="table table-sm table-striped table-hover dataset-table position-relative">
                    ...
                    <tr class="align-middle">
                        ...
                        <th scope="col" data-orderable="false" class="fw-bold th-230">
                            <div class="d-flex align-items-center">
                                <span class="label me-auto">Doctor Name</span>
                                <img class="sort-icon display-none" src="" width="16" height="16">
                            </div>
                        </th>
                        <th scope="col" data-orderable="false" class="fw-bold th-150">
                            <div class="d-flex align-items-center">
                                <span class="label me-auto">Registration #</span>
                                <img class="sort-icon display-none" src="" width="16" height="16">
                            </div>
                        </th>
                        <th scope="col" data-orderable="false" class="fw-bold th-150">
                            <div class="d-flex align-items-center">
                                <span class="label me-auto">Specialization</span>
                                <img class="sort-icon display-none" src="" width="16" height="16">
                            </div>
                        </th>
                        <th scope="col" data-orderable="false" class="fw-bold th-100">
                            <div class="d-flex align-items-center">
                                <span class="label me-auto">Patients</span>
                                <img class="sort-icon display-none" src="" width="16" height="16">
                            </div>
                        </th>
                        <th scope="col" data-orderable="false" class="fw-bold th-150 text-center">Action</th>
                        <th scope="col" data-orderable="false" class="d-none">DoctorKey</th>
                        <th scope="col" data-orderable="false" class="d-none">SortAA</th>
                    </tr>
                </thead>
                ...
                <tfoot class="d-none">
                    <tr>
                        <th></th>
                        <th class="search-col-doc-name"></th>
                        <th class="search-col-doc-regnum"></th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
    ...
    require_once($rootCwd . "includes/embed.specs-filter.php");
    ?>
 
    <form action="<?= Pages::DOCTOR_DETAILS ?>" class="frm-details d-none" method="POST">
        <input type="text" name="details-key" id="details-key">
    </form>
    <form action="<?= Tasks::DELETE_DOCTOR ?>" method="post" class="d-none frm-delete">
        <input type="text" name="record-key" id="record-key">
    </form>
    <form action="<?= Pages::EDIT_DOCTOR ?>" method="post" class="d-none frm-edit">
        <input type="text" name="record-key" id="record-key"> 
    </form>
    <form action="<?= Tasks::DEFAULT_DOCTOR ?>" method="post" class="d-none frm-change-doc">
        <input type="text" name="record-key" id="record-key"> 
    </form>
    <form action="<?= Tasks::DELETE_DOCTORS ?>" method="post" class="d-none frm-delete-records">
        <textarea name="record-keys" id="record-keys"></textarea>
    </form>
    <form action="<?= Pages::DOCTORS ?>" method="get" class="filter-form d-none">
        <input type="text" name="filter" id="filter" value="">
        <input type="text" name="query" id="query" value="">
    </form>

    <div class="d-none">
        <textarea class="default-doctor-prompt"><?= getDefaultDoctorWarning() ?></textarea>
        <textarea class="success-msg"><?= getSuccessMessage(); ?></textarea>
    </div>
    ...
    <script src="assets/js/page.view-doctor-records.js"></script>
