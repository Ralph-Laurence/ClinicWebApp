...
require_once($rootCwd . "controllers/EditPatientController.php");
...
<body>
    ...
    <div class="main-workarea flex-grow-1 d-flex flex-column h-100 bg-white shadow-2-strong overflow-hidden py-2">
        ...
        <div data-simplebar class="w-100 h-100 overflow-y-auto no-native-scroll">
            <form action="<?= Tasks::UPDATE_PATIENT ?>" method="POST" id="register-form" class="px-4 overflow-hidden needs-validation" novalidate>
                <input type="text" name="edit-key" class="d-none" value="<?= $edit_patient_key ?>">
                <input type="text" name="row-index" class="d-none row-index" value="<?= $rowIndex ?>">
                <input type="text" name="page-index" class="d-none page-index" value="<?= $pageIndex ?>">
                ...
                <!-- <div class="row">
                    <div class="col">
                        <div class="bg-red-light p-2 rounded-2 mb-3 error-message <?= $errorLabelDisplay ?>">
                            <i class="fas fa-exclamation-triangle font-red-dark me-1"></i>
                            <small class="font-red-dark error-label"><?= $errorMessage ?></small>
                        </div>
                    </div>
                    <div class="col"></div>
                </div> -->
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <div class="form-outline mb-3">
                            <input type="text" name="input-idnum" class="form-control input-idnum alphanum" value="<?= loadLastInput(Fields::$idNumber) ?>" maxlength="64" />
                            <label class="form-label" for="input-idnum">ID Number *</label>
                        </div>

                        <!-- FIRSTNAME -->
                        <div class="form-outline mb-3">
                            <input type="text" name="input-fname" class="form-control input-fname alpha" value="<?= loadLastInput(Fields::$firstName) ?>" required maxlength="32" />
                            <label class="form-label" for="input-fname">Firstname *</label>
                        </div>
                        <!-- MIDDLENAME -->
                        <div class="form-outline mb-3">
                            <input type="text" name="input-mname" class="form-control input-mname alpha" value="<?= loadLastInput(Fields::$middleName) ?>" required maxlength="32" />
                            <label class="form-label" for="input-mname">Middlename *</label>
                        </div>
                        <!-- LASTNAME -->
                        <div class="form-outline mb-3">
                            <input type="text" name="input-lname" class="form-control input-lname alpha" value="<?= loadLastInput(Fields::$lastName) ?>" required maxlength="32" />
                    ...
                    <div class="col-3">
                        <div class="d-flex align-items-center gap-2">
                            <!--BIRTHDAY-->
                            <div class="form-outline mb-3">
                                <input type="text" name="input-birthday" class="form-control input-birthday bg-white" value="<?= loadLastInput(Fields::$birthDay) ?>" readonly 
                                required style="height: 36px; max-height: 36px;"/>
                                <label class="form-label" for="input-birthday">Birthday *</label>
                            </div>
                            <div class="form-outline mb-3" style="max-width: 80px;">
                                <input type="text" name="input-age" class="form-control input-age numerics" maxlength="3" value="<?= loadLastInput(Fields::$age) ?>" required data-mdb-toggle="tooltip" title="Age is automatically calculated upon selecting birthday." style="height: 36px; max-height: 36px;">
                ...
                <div class="row pt-4">
                    ...
                    <div class="col"> 
                        <div class="d-flex flex-row align-items-center justify-content-end gap-2">
                            ...
                            <button type="button" class="btn btn-secondary btn-base btn-submit">Save</button>
                        </div>
                        <textarea class="d-none cancel-route"><?= ENV_SITE_ROOT . Pages::PATIENTS ?></textarea>
                    </div>
                </div>
