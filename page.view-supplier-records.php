...
require_once($rootCwd . "controllers/SupplierRecordsController.php");
?>
...
<body>
    ...
    <div class="main-workarea flex-grow-1 d-flex flex-column h-100 bg-white shadow-2-strong overflow-hidden px-4 py-2">
        ...
        <!--SEARCH BARS-->
        <div class="searchbar-wrapper display-nonex effect-reciever" data-transition-index="0" data-transition="fadein">
                ...
                <div class="left-half me-auto">
                    <div class="control-elements d-flex flex-row gap-2 flex-wrap">
                        <div class="form-outline">
                            ...
                            <label class="form-label" for="form12">Find Supplier</label>
                        </div>
                        <div class="selectmenu-wrapper">
                            <select class="combo-box">
                                <option value="0">By Name</option>
                                <option value="1">By Email</option>
                                <option value="2">By Contact No.</option>
                                <option value="3">By Supplier ID</option>
                            </select>
                        </div>
                    ...
                    <div class="control-elements d-flex flex-row gap-2 flex-wrap">
                            ...
                            <ul class="dropdown-menu shadow-3-strong dropdown-menu-custom-light py-2" aria-labelledby="sort-dropdown-button ul-li-pointer">
                                ...
                                <li onclick="sortBy(1, 1)" class="d-flex align-items-center gap-3 px-3 py-1 dropdown-item-custom-light">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="fs-6">Supplier ID</div>
                                    </div>
                                </li>
                                <li onclick="sortBy(2, 1)" class="d-flex align-items-center gap-3 px-3 py-1 dropdown-item-custom-light">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="assets/images/icons/sort-up.png" width="18" height="18">
                                        <div class="fs-6">Supplier Name</div>
                                    </div>
                                </li> 
                                <li>
                        ...
                        <div class="dropdown actionbar-options">
                            ...
                            <ul class="dropdown-menu shadow-3-strong dropdown-menu-custom-light py-2" aria-labelledby="options-dropdown-button ul-li-pointer">
                                ...
                                <li>
                                    <a href="<?= Pages::REGISTER_SUPPLIER ?>" class="d-flex align-items-center gap-3 px-3 py-1 dropdown-item-custom-light">
                                        <div class="dropdown-item-icon text-center"></div>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="assets/images/icons/icn_plus.png" width="18" height="18">
                                            <div class="fs-6">Add Supplier</div>
                                        </div>
                                    </a>
                                </li>
            ...
            <div class="col col-count-indicators d-flex gap-2 align-items-center flex-wrap">
                ...
                <div class="display-nonex effect-reciever" data-transition-index="1" data-transition="fadein">
                    <div class="capsule-badge fsz-14 text-white d-flex align-items-center">
                        <div class="capsule-badge-bg rounded-start px-2">Total Suppliers</div>
                        <div class="bg-green rounded-end px-2 capsule-badge-indicator"><?= $totalSuppliers ?></div>
                    </div>
                </div>
        ...
        <div data-simplebar class="w-100 h-100 overflow-y-auto no-native-scroll datatable-wrapper border display-nonex effect-reciever" data-transition-index="2" data-transition="fadein">
            <table class="table table-sm table-striped table-hover dataset-table position-relative">
                    ...
                    <tr class="align-middle">
                        ...
                        <th scope="col" data-orderable="false" class="fw-bold th-100">
                            <div class="d-flex align-items-center">
                                <span class="label me-auto">ID</span>
                                <img class="sort-icon display-none" src="" width="16" height="16">
                            </div>
                        </th>
                        <th scope="col" data-orderable="false" class="fw-bold th-230">
                            <div class="d-flex align-items-center">
                                <span class="label me-auto">Supplier Name</span>
                                <img class="sort-icon display-none" src="" width="16" height="16">
                            </div>
                        </th>
                        <th scope="col" data-orderable="false" class="fw-bold text-truncate th-150">Contact</th>
                        <th scope="col" data-orderable="false" class="fw-bold text-truncate th-150">Email</th>
                        <th scope="col" data-orderable="false" class="fw-bold th-150 text-center">Action</th>
                        <th scope="col" data-orderable="false" class="d-none">SupplierKey</th> 
                    </tr>
                </thead>
                ...
                <tfoot class="d-none">
                    <tr>
                        <th></th>
                        <th class="search-col-sup-id"></th>
                        <th class="search-col-sup-name"></th>
                        <th class="search-col-sup-contact"></th>
                        <th class="search-col-sup-email"></th>
                        <th></th>
                        <th></th> 
                    </tr>
                </tfoot>
    ...
    ?>
    <form action="<?= Pages::SUPPLIER_DETAILS ?>" class="frm-details d-none" method="POST">
        <input type="text" name="details-key" id="details-key">
    </form>

    <?php // Hidden form; This will handle a record's DELETE action 
    ?>
    <form action="<?= Tasks::DELETE_SUPPLIER ?>" method="POST" class="frm-delete d-none">
    ...
    ?>
    <form action="<?= Pages::EDIT_SUPPLIER ?>" method="POST" class="frm-edit d-none">
    ...
    //
    ?>
    <form action="<?= Tasks::DELETE_SUPPLIERS ?>" method="POST" class="frm-delete-records d-none">
    ...
    <form class="frm-session-var">
        <input type="text" class="d-none success-message" value="<?= getSuccessMessage() ?>">
        <textarea class="d-none edited-row-emphasis"><?php //= trim(getEditRowEmphasizeData()) ?></textarea>
    </form>
    ...
    <script src="assets/js/page.view-supplier-records.js"></script>
