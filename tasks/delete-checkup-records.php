...
$record_keys = $_POST['record-keys'] ?? ""; // JSON - encoded values
...
{ 
    ...
    $db->deleteWhereIn( TableNames::checkup_details, CheckupFields::$id, $recordIds);

    $_SESSION['checkup-records-action-success'] = "The selected records were removed successfully.";
