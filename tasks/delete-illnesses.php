...
{ 
    ...
    // delete every illness records with matching record id
    $db->deleteWhereIn( TableNames::illness, Illness::getFields()->id, $recordIds);

    Response::Redirect( (ENV_SITE_ROOT . Pages::ILLNESS),
        Response::Code200, 
        "The selected illnesses were successfully removed.",
