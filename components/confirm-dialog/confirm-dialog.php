<div class="modal fade confirmDialogModal" id="confirmDialogModal" tabindex="-1" aria-labelledby="confirmDialogModalLabel" aria-hidden="true">
    <div class="modal-dialog pt-3">
        <div class="modal-content mt-5">
            ...
            <div class="modal-body confirmDialogModalBody px-4" style="white-space: pre-line;">
                Message
            </div>
